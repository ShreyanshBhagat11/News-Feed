...
class technologyfragment : Fragment() {
    ...
    var country = "in"
    private var recyclerViewoftechnology: RecyclerView? = null
    private val categgory = "technology"
    override fun onCreateView(
        ...
        recyclerViewoftechnology?.setLayoutManager(LinearLayoutManager(context))
